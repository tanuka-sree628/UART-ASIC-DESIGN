...
Checkpoint used for visualization: `13-openroad-floorplan/uart_top.odb`
...
- **Global routing** (`39-openroad-globalrouting/`) — determines approximate routing paths and resource allocation across the design.
- **Detailed routing** (`44-openroad-detailedrouting/`) — creates the actual physical metal and via connections in accordance with SKY130 design rules.
...
Final GDSII file: `final/gds/uart_top.gds`
